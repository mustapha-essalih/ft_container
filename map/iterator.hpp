    ...
    template <typename key_type, class T,typename key_compare,typename size_type,typename mapped_type,typename Allocator  >
        ...
        {   
            public:
                ...
                Node<key_type,size_type,mapped_type> * node;             
            
                
                map_iterator():node(0){}
            
                map_iterator(Node<key_type,size_type,mapped_type> * n):node(n){}
            ...
            private:
                friend class avl;
                avl<key_type,value_type,key_compare,size_type,mapped_type,Allocator> a;
